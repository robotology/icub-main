...
IF(NOT AFFACTIONPRIMITIVES_FOUND)
    ...
    IF(NESTED_BUILD)
        ...
        IF(WIN32 AND NOT CYGWIN)
           FIND_LIBRARY(AFFACTIONPRIMITIVES_LIBRARIES_RELEASE affActionPrimitives  ${ICUB_DIR}/lib/Release NO_DEFAULT_PATH)
           FIND_LIBRARY(AFFACTIONPRIMITIVES_LIBRARIES_DEBUG   affActionPrimitivesd ${ICUB_DIR}/lib/Debug   NO_DEFAULT_PATH)
           SET(AFFACTIONPRIMITIVES_LIBRARIES optimized ${AFFACTIONPRIMITIVES_LIBRARIES_RELEASE} debug ${AFFACTIONPRIMITIVES_LIBRARIES_DEBUG})
