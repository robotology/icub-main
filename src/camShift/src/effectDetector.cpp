//PROBLEMS:
//* the respond method seems to be working only once if I send it data from yarp write. is this happening because I am not reading its response?
//* some initialization values are hardcoded, instead of read from an initialization file.

//THINGS THAT SHOULD BE TESTED:
//* is the histogram created in the correct way?
//* similarity() assumes the HSV pixels have minimum values of [0,0,0] and maximum values of [255,255,255]

//THINGS THAT WORK:
//the response method is reading images on two ports and computing a similarity between the ROI's.
...
//     }
    ...
    //FINO A QUI HO OTTENUTO UN'IMMAGINE IN FORMATO OPENCV BGR, in BUFFER
