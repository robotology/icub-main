...
//#define DEBUG_TORQUES
	...
	else
	{
		if(Network::exists(string("/"+wholeBodyName+"/filtered/inertial:o").c_str()))
		{
			...
			printf("left  leg: %.3lf, %.3lf, %.3lf, %.3lf, %.3lf, %.3lf, %.3lf\n", torques_LL(0), torques_LL(1), torques_LL(2), torques_LL(3), torques_LL(4), torques_LL(5), torques_LL(6)); 
			printf("right leg: %.3lf, %.3lf, %.3lf, %.3lf, %.3lf, %.3lf, %.3lf\n", torques_RL(0), torques_RL(1), torques_RL(2), torques_RL(3), torques_RL(4), torques_RL(5), torques_RL(6)); 
