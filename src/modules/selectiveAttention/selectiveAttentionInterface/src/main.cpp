...
int main(int argc, char *argv[]) {
    ...
    if(argc<2){
        ...
        printf("e.g selectiveAttentionInterface --name /selectiveAttentionInterface \n");
        printf(" \n");
        printf(" \n");
        return 0;
    }
    ...
    selectiveAttentionModule *module=new selectiveAttentionModule();
    ...
    gtk_init (&argc, &argv);
    //mainWindow = module->gui->createMainWindow();
    //gtk_widget_show_all (mainWindow);
    //gtk_window_move(GTK_WINDOW(mainWindow),200,200);
