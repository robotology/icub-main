...
struct detection_data
{
  ...
  int octv;
  int intvl;
  double subintvl; //subpixel precision?
  double scl_octv;
};
...
/** default threshold on keypoint contrast |D(x)| */ //estava 0.04
...
*/
extern struct feature* new_feature( void );
...
*/
extern struct feature* clone_feature( struct feature* feat);

/**
  Makes a deep copy of a feature

  @param new_feat pointer to allocated feature memory
  @param feat feature to be cloned

*/
extern void clone_feature( struct feature* new_feat, struct feature* feat);
