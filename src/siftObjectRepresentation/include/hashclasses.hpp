...
*/
    ...
    template<typename Value>
    class CharPtrMultiHash: public
        __gnu_cxx::hash_multimap<char const *, Value, HashCharPtr, EqualCharPtr >
    {
        public:
            CharPtrMultiHash()
            {}
            template <typename InputIterator>
            CharPtrMultiHash(InputIterator first, InputIterator beyond)
            :
                __gnu_cxx::hash_multimap<char const *, Value, HashCharPtr,
                                    EqualCharPtr>(first, beyond)
            {}
    };

    template<typename Value>
    class CharCasePtrMultiHash: public
        __gnu_cxx::hash_multimap<char const *, Value, HashCaseCharPtr,
                                                 EqualCaseCharPtr >
    {
        public:
            CharCasePtrMultiHash()
            {}
            template <typename InputIterator>
            CharCasePtrMultiHash(InputIterator first, InputIterator beyond)
            :
                __gnu_cxx::hash_multimap<char const *, Value,
                            HashCaseCharPtr, EqualCaseCharPtr>
                            (first, beyond)
            {}
    };
    ...
    template<typename Value>
    class StringMultiHash: public __gnu_cxx::hash_multimap<std::string, Value,
                                                 HashString>
    {
        public:
            StringMultiHash()
            :
                __gnu_cxx::hash_multimap<std::string, Value, HashString>()
            {}
            
            StringMultiHash(int n)
            :
                __gnu_cxx::hash_multimap<std::string, Value, HashString>( n )
            {}
            
            template <typename InputIterator>
            StringMultiHash(InputIterator first, InputIterator beyond)
            :
                __gnu_cxx::hash_multimap<std::string, Value, HashString>
                             (first, beyond)
            {}
    ...
    template<typename Value>
    class StringCaseMultiHash: public
            __gnu_cxx::hash_multimap<std::string, int, HashCaseString,
                                EqualCaseString>
    {
        public:
            StringCaseMultiHash()
            {}
            template <typename InputIterator>
            StringCaseMultiHash(InputIterator first, InputIterator beyond)
            :
                __gnu_cxx::hash_multimap<std::string,
                            int, HashCaseString,
                            EqualCaseString>(first, beyond)
            {}
    };
...
/*
    template<typename Key, typename Value>
    class MultiHash: public
            __gnu_cxx::hash_multimap<Key, Value,
                        __gnu_cxx::hash<Key>(),
                        equal<Key>()>
    {};
*/
