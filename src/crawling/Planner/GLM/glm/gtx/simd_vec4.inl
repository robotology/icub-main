...
namespace glm
{
	namespace detail
	{
		__m128 fvec4SIMD::one = _mm_set1_ps(1.f);
		...
		inline fvec4SIMD::fvec4SIMD(fvec4SIMD::no_init NoInit)
		{}
		...
		inline fvec4SIMD::fvec4SIMD(float s) :
			Data(_mm_set1_ps(s))
		{}

		inline fvec4SIMD::fvec4SIMD(float x, float y, float z, float w) :
	//		Data(_mm_setr_ps(x, y, z, w))
			Data(_mm_set_ps(w, z, y, x))
		{}

		inline fvec4SIMD::fvec4SIMD(float v[4]) :
			Data(_mm_load_ps(v))
		{}
		...
		{
			__m128 Tmp = _mm_load_ps1(&s);
			this->Data = _mm_add_ps(Data, Tmp);
			return *this;
		}
		...
		inline fvec4SIMD operator+ (fvec4SIMD const & v, float s)
		{
			...
			return fvec4SIMD(_mm_add_ps(par0, par1));
		}
		...
		inline fvec4SIMD operator- (fvec4SIMD const & v, float s)
		{
			__m128 par0 = v.Data;
			__m128 par1 = _mm_set1_ps(s);
			return fvec4SIMD(_mm_sub_ps(par0, par1));
		}
		...
		{
			return fvec4SIMD(_mm_sub_ps(glm::detail::zero, v.Data));
		}
