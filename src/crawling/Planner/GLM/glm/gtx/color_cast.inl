...
template <>
inline detail::half f16_channel_cast<uint16>(uint16 color)
{
	return detail::half(static_cast<float>(color >>  0) / static_cast<float>(65535));
}

template <>
inline detail::tvec3<detail::half> f16_rgbx_cast<uint64>(uint64 color)
{
	detail::tvec3<detail::half> result;
	result.x = detail::half(static_cast<float>(color >>  0) / static_cast<float>(65535));
	result.y = detail::half(static_cast<float>(color >> 16) / static_cast<float>(65535));
	result.z = detail::half(static_cast<float>(color >> 32) / static_cast<float>(65535));
	return result;
}

template <>
inline detail::tvec3<detail::half> f16_xrgb_cast<uint64>(uint64 color)
{
	detail::tvec3<detail::half> result;
	result.x = detail::half(static_cast<float>(color >> 16) / static_cast<float>(65535));
	result.y = detail::half(static_cast<float>(color >> 32) / static_cast<float>(65535));
	result.z = detail::half(static_cast<float>(color >> 48) / static_cast<float>(65535));
	return result;
}

template <>
inline detail::tvec3<detail::half> f16_bgrx_cast<uint64>(uint64 color)
{
	detail::tvec3<detail::half> result;
	result.x = detail::half(static_cast<float>(color >> 32) / static_cast<float>(65535));
	result.y = detail::half(static_cast<float>(color >> 16) / static_cast<float>(65535));
	result.z = detail::half(static_cast<float>(color >>  0) / static_cast<float>(65535));
	return result;
}

template <>
inline detail::tvec3<detail::half> f16_xbgr_cast<uint64>(uint64 color)
{
	detail::tvec3<detail::half> result;
	result.x = detail::half(static_cast<float>(color >> 48) / static_cast<float>(65535));
	result.y = detail::half(static_cast<float>(color >> 32) / static_cast<float>(65535));
	result.z = detail::half(static_cast<float>(color >> 16) / static_cast<float>(65535));
	return result;
}

template <>
inline detail::tvec4<detail::half> f16_rgba_cast<uint64>(uint64 color)
{
	detail::tvec4<detail::half> result;
	result.x = detail::half(static_cast<float>(color >>  0) / static_cast<float>(65535));
	result.y = detail::half(static_cast<float>(color >> 16) / static_cast<float>(65535));
	result.z = detail::half(static_cast<float>(color >> 32) / static_cast<float>(65535));
	result.w = detail::half(static_cast<float>(color >> 48) / static_cast<float>(65535));
	return result;
}

template <>
inline detail::tvec4<detail::half> f16_argb_cast<uint64>(uint64 color)
{
	detail::tvec4<detail::half> result;
	result.x = detail::half(static_cast<float>(color >> 16) / static_cast<float>(65535));
	result.y = detail::half(static_cast<float>(color >> 32) / static_cast<float>(65535));
	result.z = detail::half(static_cast<float>(color >> 48) / static_cast<float>(65535));
	result.w = detail::half(static_cast<float>(color >>  0) / static_cast<float>(65535));
	return result;
}

template <>
inline detail::tvec4<detail::half> f16_bgra_cast<uint64>(uint64 color)
{
	detail::tvec4<detail::half> result;
	result.x = detail::half(static_cast<float>(color >> 32) / static_cast<float>(65535));
	result.y = detail::half(static_cast<float>(color >> 16) / static_cast<float>(65535));
...
template <>
inline detail::tvec4<detail::half> f16_abgr_cast<uint64>(uint64 color)
{
	detail::tvec4<detail::half> result;
	result.x = detail::half(static_cast<float>(color >> 48) / static_cast<float>(65535));
	result.y = detail::half(static_cast<float>(color >> 32) / static_cast<float>(65535));
