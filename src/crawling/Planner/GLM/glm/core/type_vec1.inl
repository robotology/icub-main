...
namespace glm
{
	namespace detail
	{
		...
		template <typename valType>
		tvec1<valType>& tvec1<valType>::operator+=(valType s)
		{
			this->x += s;
			return *this;
		}
		...
		template <typename T> 
		inline tvec1<T> operator+ (const tvec1<T>& v, T s)
		{
			return tvec1<T>(
				v.x + s);
		}
		...
		template <typename T> 
		inline tvec1<T> operator+ (T s, const tvec1<T>& v)
		{
			return tvec1<T>(
				s + v.x);
		}
		...
		template <typename T> 
		inline const tvec1<T> operator-- (const tvec1<T>& v, int)
		{
			return tvec1<T>(
				v.x - T(1));
		}
		...
		template <typename T> 
		inline const tvec1<T> operator~ (const tvec1<T>& v)
		{
			return tvec1<T>(
				~v.x);
		}
