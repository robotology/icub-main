...
namespace glm
{
	namespace detail
	{
		...
		template <typename Type>
		inline tvec2<Type>::tvec2(const tvec2<Type>& v) :
			x(v.x),
			y(v.y)
		{}
		...
		template <typename Type>
		inline tvec2<Type>::tvec2(Type s) :
			x(s),
			y(s)
		{}

		template <typename Type>
		inline tvec2<Type>::tvec2(Type s1, Type s2) :
			x(s1),
			y(s2)
		{}
		...
		template <typename Type>
		inline tvec2<Type>::tvec2(const tref2<Type>& r) :
			x(r.x),
			y(r.y)
		{}
		...
		template <typename valType>
		template <typename U> 
		inline tvec2<valType>::tvec2(const tvec2<U>& v) :
			x(valType(v.x)),
			y(valType(v.y))
		{}
		...
		template <typename valType>
		template <typename U> 
		inline tvec2<valType>::tvec2(const tvec3<U>& v) :
			x(valType(v.x)),
			y(valType(v.y))
		{}
		...
		template <typename valType>
		template <typename U> 
		inline tvec2<valType>::tvec2(const tvec4<U>& v) :
			x(valType(v.x)),
			y(valType(v.y))
		{}
		...
		template <typename valType>
		inline tvec2<valType>& tvec2<valType>::operator= (const tvec2<valType>& v)
		{
			this->x = v.x;
			this->y = v.y;
			return *this;
		...
		template <typename valType>
		inline tvec2<valType>& tvec2<valType>::operator+=(valType s)
		{
			this->x += s;
			this->y += s;
			return *this;
		...
		template <typename valType>
		inline tvec2<valType> const tvec2<valType>::swizzle(comp x, comp y) const
		{
		...
		template <typename valType>
		inline tvec3<valType> const tvec2<valType>::swizzle(comp x, comp y, comp z) const
		{
		...
		template <typename valType>
		inline tvec4<valType> const tvec2<valType>::swizzle(comp x, comp y, comp z, comp w) const
		{
		...
		template <typename T> 
		inline tvec2<T> operator++ (const tvec2<T>& v, int)
		{
			return tvec2<T>(
				v.x + T(1), 
				v.y + T(1));
		...
		template <typename T> 
		inline const tvec2<T> operator-- (const tvec2<T>& v, int)
		{
			return tvec2<T>(
				v.x - T(1), 
				v.y - T(1));
		...
		template <typename T> 
		inline const tvec2<T> operator~ (const tvec2<T>& v)
		{
			return tvec2<T>(
				~v.x,
				~v.y);
