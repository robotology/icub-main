...
namespace glm
{
	namespace detail
	{
		...
		template <typename valType>
		inline tvec3<valType>& tvec3<valType>::operator+=(valType s)
		{
			this->x += s;
			this->y += s;
			this->z += s;
		...
		template <typename valType>
		inline tvec2<valType> const tvec3<valType>::swizzle(comp x, comp y) const
		{
		...
		template <typename valType>
		inline tvec3<valType> const tvec3<valType>::swizzle(comp x, comp y, comp z) const
		{
		...
		template <typename valType>
		inline tvec4<valType> const tvec3<valType>::swizzle(comp x, comp y, comp z, comp w) const
		{
		...
		template <typename T> 
		inline const tvec3<T> operator-- (const tvec3<T>& v, int)
		{
			return tvec3<T>(
				v.x - T(1), 
				v.y - T(1), 
		...
		template <typename T> 
		inline const tvec3<T> operator~ (const tvec3<T>& v)
		{
			return tvec3<T>(
				~v.x,
				~v.y,
