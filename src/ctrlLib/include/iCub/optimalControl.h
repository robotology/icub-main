...
public:
     ...
     */
	 ...
	 /**
     * Get stored L_i matrix. Call this function only after doRiccati()
     * 
     ...
     */
	 ...
	 /**
     * Get stored T_i matrix. Call this function only after doRiccati()
     * 
     * @param step The time index of the i-th matrix
     */
     ...
     */
	 ...
	 /**
     * Enable or disable verbose feedback (i.e. printing additional information) 
     * 
