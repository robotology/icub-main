...
MEMORY {
        ...
        .p_Code2  (RWX) : ORIGIN = 0x0000F804, LENGTH = 0x000007B2
        .p_Code1  (RWX) : ORIGIN = 0x0000FFB6, LENGTH = 0x00018
        ...
        # in the data_in_p_flash_ROM section definition 0x00000FC0

        .p_flash_ROM_data  (RX) : ORIGIN = 0x00000040, LENGTH = 0x00000031
