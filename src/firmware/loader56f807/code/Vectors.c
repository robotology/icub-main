...
extern void _MyEntryPoint(void);         // Startup routine //
...
static asm void _vectboot(void) {
  JMP  _MyEntryPoint                     // Reset vector (Used) //
  JMP  _MyEntryPoint                     // COP reset vector (Used) //
}
...
static asm void _vect(void) {
  JMP  _MyEntryPoint                     // Interrupt no. 0 (Used)   - ivINT_Reset //
  JMP  _MyEntryPoint                     // Interrupt no. 1 (Used)   - ivINT_COPReset  //
