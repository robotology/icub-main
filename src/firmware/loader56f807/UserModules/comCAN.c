...
//
////////////////////////////////////////////////////////////////////////
void comSendAddInfo(void)
{
//	byte jj = 0;
//	byte write_buffer = 0;
//   byte counter = 0;
//   UInt16 tout=0;
	CAN_data[0] = CMD_ADDINFO;	
//	CAN_data[1] = 0; 
	CAN_data[2] = _add_info[0]; 	
	CAN_data[3] = _add_info[1]; 
	CAN_data[4] = _add_info[2]; 	
	CAN_data[5] = _add_info[3]; 	
	CAN1_sendFrame(CAN_messID, 6, CAN_data); 		
}
