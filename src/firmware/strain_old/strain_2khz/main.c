...
{    
  ...
  if (BoardConfig.EE_AN_SelectedChannel >= muxed_chans+2)    BoardConfig.EE_AN_SelectedChannel=0;
  else  BoardConfig.EE_AN_SelectedChannel++;

//-------------------
/*  if      (BoardConfig.EE_AN_SelectedChannel==1) BoardConfig.EE_AN_SelectedChannel=2;
  else if (BoardConfig.EE_AN_SelectedChannel==3) BoardConfig.EE_AN_SelectedChannel=4;
  else if (BoardConfig.EE_AN_SelectedChannel==5) BoardConfig.EE_AN_SelectedChannel=6;*/
  if      (BoardConfig.EE_AN_SelectedChannel==0) BoardConfig.EE_AN_SelectedChannel=3;
//  else if (BoardConfig.EE_AN_SelectedChannel==2) BoardConfig.EE_AN_SelectedChannel=3;
//  else if (BoardConfig.EE_AN_SelectedChannel==4) BoardConfig.EE_AN_SelectedChannel=5;
//-------------------
 ...
 ConfigIntSPI1(SPI_INT_PRI_4 &  SPI_INT_EN);
  ...
  if (BoardConfig.EE_AN_ChannelScanningTime >= 2097)
    match_value = 0xFFFF;
      ...
      match_value = (20.00 * BoardConfig.EE_AN_ChannelScanningTime); // 1 sample = 67 us
//  	    match_value = (31.25 * BoardConfig.EE_AN_ChannelScanningTime); // 1 sample = 100 us
