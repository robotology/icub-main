...
{ \
	...
	{ \
		...
		init_trajectory_vel (i, _position[i], _position[i], 1); \
...
{ \
	...
	{ \
		...
		init_trajectory_vel (0, _position[0], _position[0], 1); \
		_general_board_error = ERROR_NONE; \
	} \
	else \
	{ \
		...
		init_trajectory_vel (1, _position[1], _position[1], 1); \
		_general_board_error = ERROR_NONE; \
	} \
}
...
{ \
	...
	{ \
		...
		{ \
			...
			_set_acc[i] = 0; \
			init_trajectory_vel (i, _desired[i], _set_point[i], _set_vel[i]); \
			_general_board_error = ERROR_NONE; \
		} \
		else \
			_general_board_error = ERROR_MODE; \
