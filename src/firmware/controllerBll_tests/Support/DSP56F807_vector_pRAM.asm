...
M56807_intDef:
	...
	jmp M56807_intRoutine    ; mscan transmitter ready  ($1C)
	jmp M56807_intRoutine    ; mscan receiver full      ($1E)
	jmp M56807_intRoutine    ; mscan error              ($20)
	jmp M56807_intRoutine    ; mscan wakeup             ($22)
	...
	jmp M56807_intRoutine    ; SCI #0 transmitter ready ($66)
	jmp M56807_intRoutine    ; SCI #0 receiver error    ($68)
	jmp M56807_intRoutine    ; SCI #0 receiver full     ($6a)
