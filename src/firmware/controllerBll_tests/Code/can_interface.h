...
// can messages
/******************************************************/
#define CLASS_POLLING_DSP   0x00
#define CLASS_PERIODIC_DSP  0x01
#define CLASS_POLLING_SENS  0x02
#define CLASS_PERIODIC_SENS 0x03
#define CLASS_CANLOADER     0x07
