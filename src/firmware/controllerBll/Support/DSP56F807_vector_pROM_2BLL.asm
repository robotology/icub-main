...
M56807_intDef:
	...
	jsr FTD0_interrupt	     ; Timer D Channel 0        ($3C)
	...
	jsr FInterrupt_Phase_X1  ; Timer B Channel 0        ($4c)
	jsr FInterrupt_Phase_Y1  ; Timer B Channel 1        ($4e)
	jsr FInterrupt_Phase_Z1  ; Timer B Channel 2        ($50)
	jmp M56807_intRoutine    ; Timer B Channel 3        ($52)
	jsr FInterrupt_Phase_X0  ; Timer A Channel 0        ($54)
	jsr FInterrupt_Phase_Y0  ; Timer A Channel 1        ($56)
	jsr FInterrupt_Phase_Z0  ; Timer A Channel 2        ($58)
	...
	jsr FFaultB_Interrupt    ; PWM B Fault	 		    ($78)
	jsr FFaultA_Interrupt    ; PWM A Fault	 		    ($7a)
