...
void PWM_A_init(void)
{
	...
	/* PWMA_PMCFG: ??=0,??=0,??=0,EDG=0,??=0,TOPNEG45=0,TOPNEG23=0,TOPNEG01=0,??=0,BOTNEG45=0,BOTNEG23=0,BOTNEG01=0,INDEP45=1,INDEP23=1,INDEP01=1,WP=0 */
	setReg (PWMA_PMCFG, 0x0E);           
 ...
 */
/**************************************************************************************/
byte PWM_A_setPeriod (word period)
{
	if (period < 32768)
 ...
 */
/**************************************************************************************/
byte PWM_A_setPrescaler(byte presc)
{
	if (presc < 4) 
	{
