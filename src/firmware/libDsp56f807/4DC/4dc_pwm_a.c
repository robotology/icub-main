...
void PWM_A_init(void)
{
	...
	/* PWMA_PMOUT: PAD_EN=0,??=0,OUTCTL=111111,??=0,??=0,OUT=0 */
	setReg (PWMA_PMOUT, 0x3F00);

	/* PWMA_PMCCR: ENHA=0,??=0,MSK=0,??=0,??=0,VLMODE=0,??=0,SWP45=0,SWP23=0,SWP01=0 */
	setReg (PWMA_PMCCR, 0);
       
	/* PWMA_PMCFG: ??=0,??=0,??=0,EDG=1,??=0,TOPNEG45=0,TOPNEG23=0,TOPNEG01=0,??=0,BOTNEG45=0,BOTNEG23=0,BOTNEG01=0,INDEP45=1,INDEP23=1,INDEP01=1,WP=0 */
	setReg (PWMA_PMCFG, 0x100E);           

	/* PWMA_PMDEADTM: ??=0,??=0,??=0,??=0,??=0,??=0,??=0,??=0,PWMDT=0 */
	setReg (PWMA_PMDEADTM, 0);          

	/* PWMA_PWMVAL0: PWMVAL=0 */
	setReg (PWMA_PWMVAL0, 0x0);            

	/* PWMA_PWMVAL1: PWMVAL=0 */
	setReg (PWMA_PWMVAL1, 0x0);         

	/* PWMA_PWMVAL2: PWMVAL=0 */
	setReg (PWMA_PWMVAL2, 0);            

	/* PWMA_PWMVAL3: PWMVAL=0 */
	setReg (PWMA_PWMVAL3, 0x0);         

	/* PWMA_PWMVAL4: PWMVAL=0 */
	setReg (PWMA_PWMVAL4, 0);            

	/* PWMA_PWMVAL5: PWMVAL=0 */
	setReg (PWMA_PWMVAL5, 0x0);         
...
void PWM_A_outputPadEnable (word mask)
{
	...
	setRegBits(PWMA_PMOUT, 0x8000); //PAD_EN=1
 	reset_faults_PWMA();
}
