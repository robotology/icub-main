...
#include <iCub/eyeTriangulation.h>

/**
  *
  * @ingroup icub_module
  * \defgroup icub_dvsIntegrator dvsIntegrator
  *
  * Extracts absolute coordinates from image planes coordinates for the dvs cameras mounted in the eyes and cameras
  * mounted on the head
  *
