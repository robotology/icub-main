...
public:
	...
	const char	*cam1_in_port;
	const char	*cam2_in_port;
	const char	*enc_in_port;

	// interface to the outside world
	const char	*cam1_out_port;
	const char	*cam2_out_port;

	// markerTracker position ports (for the outside world)
	const char	*trackerLeft_out_port;
	const char	*trackerRight_out_port;
