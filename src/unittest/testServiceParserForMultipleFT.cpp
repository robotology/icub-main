...
TEST(General, check_settings_positive_002)
{
	...
	std::map<std::string /*sensor id*/, FtInfo> expected = {{"fakeId", {10, 100, eoas_ft_mode_calibrated, "none", 0, 0, 0, 0, 0, 0, 0}}, {"fakeId1", {20, 200, eoas_ft_mode_raw, "none", 0, 0, 0, 0, 0, 0, 0}}};
