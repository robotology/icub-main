...
inline bool operator!=(const eObrd_firmwareversion_t &right, const eObrd_firmwareversion_t &left) { return !(right == left); }
...
inline bool operator!=(const eObrd_protocolversion_t &right, const eObrd_protocolversion_t &left) { return !(right == left); }
...
inline bool operator!=(const eObrd_canlocation_t &right, const eObrd_canlocation_t &left) { return !(right == left); }
...
inline bool operator!=(const eOas_ft_sensordescriptor_t &right, const eOas_ft_sensordescriptor_t &left) { return !(right == left); }
