...
TEST(ServiceParserMultipleFT, check_settings_positive_002)
{
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_settings_negative_001)
{
    yarp::os::Bottle bottle;
    bottle.fromString(
...
TEST(ServiceParserMultipleFT, check_settings_negative_002)
{
    yarp::os::Bottle bottle;
    bottle.fromString(
...
TEST(ServiceParserMultipleFT, check_settings_negative_003)
{
    yarp::os::Bottle bottle;
    bottle.fromString(
...
TEST(ServiceParserMultipleFT, check_settings_negative_004)
{
    yarp::os::Bottle bottle;
    bottle.fromString(
...
TEST(ServiceParserMultipleFT, check_property_sensors_positive_001)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
    bottle.fromString("(SENSORS (id fakeId) (board strain2) (location CAN2:13) (framename fakeFrameName) )");
    serviceParser.ftInfo_ = {{"fakeId", {10, 100, eoas_ft_mode_calibrated, eobrd_unknown, 0, 0, 0, 0, 0, 0, 0, "fakeFrameName"}}};

    bool ret = serviceParser.checkPropertySensors(bottle);

    std::map<std::string /*sensor id*/, FtInfo> expected = {{"fakeId", {10, 100, eoas_ft_mode_calibrated, eobrd_strain2, 2, 13, 0, 0, 0, 0, 0, "fakeFrameName"}}};
...
TEST(ServiceParserMultipleFT, check_property_sensors_positive_002)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
    bottle.fromString("(SENSORS (id fakeId fakeId1) (board strain2 strain2) (location CAN2:13 CAN2:14) (framename fakeFrameName1 fakeFrameName2) )");
    serviceParser.ftInfo_ = {{"fakeId", {10, 100, eoas_ft_mode_calibrated, eobrd_unknown, 2, 13, 0, 0, 0, 0, 0, "fakeFrameName1"}},
                             {"fakeId1", {20, 200, eoas_ft_mode_raw, eobrd_unknown, 2, 14, 0, 0, 0, 0, 0, "fakeFrameName2"}}};

    bool ret = serviceParser.checkPropertySensors(bottle);

    std::map<std::string /*sensor id*/, FtInfo> expected = {{"fakeId", {10, 100, eoas_ft_mode_calibrated, eobrd_strain2, 2, 13, 0, 0, 0, 0, 0, "fakeFrameName1"}},
                                                            {"fakeId1", {20, 200, eoas_ft_mode_raw, eobrd_strain2, 2, 14, 0, 0, 0, 0, 0, "fakeFrameName2"}}};
...
TEST(ServiceParserMultipleFT, check_property_sensors_positive_003)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_property_sensors_positive_004)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_property_sensors_positive_005)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_property_sensors_negative_001)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_property_sensors_negative_002)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_property_sensors_negative_003)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
    bottle.fromString("(SENSORS (id fakeId fakeId1) (board strain2 strain2) (location CAN2:13 CAN2:14) )");
...
TEST(ServiceParserMultipleFT, check_property_sensors_negative_004)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_property_canboards_positive_001)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_property_canboards_positive_002)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
    bottle.fromString("(CANBOARDS (type strain2) (PROTOCOL (major 2) (minor 3) ) (FIRMWARE (major 4) (minor 5) (build 6) ) )");
...
TEST(ServiceParserMultipleFT, check_property_canboards_positive_003)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_property_canboards_positive_004)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_property_canboards_negative_001)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
    bottle.fromString("(CANBOARDS (type strain2 strain) (PROTOCOL (major 2 7) (minor 3 8) ) (FIRMWARE (major 4 9) (minor 5 10) (build 6 11) ) )");
...
TEST(ServiceParserMultipleFT, check_property_canboards_negative_002)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_property_canboards_negative_003)
{
    ServiceParserMultipleFt_mock serviceParser;
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_checkCanMonitor_positive_001)
{
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_checkCanMonitor_negative_001)
{
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_checkCanMonitor_negative_002)
{
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, check_checkCanMonitor_negative_003)
{
    yarp::os::Bottle bottle;
...
TEST(ServiceParserMultipleFT, toEomn_positive_001)
{
...
TEST(ServiceParserMultipleFT, toEomn_positive_002)
{
...
TEST(ServiceParserMultipleFT, toEomn_negative_001)
{
...
TEST(ServiceParserMultipleFT, checkBoardType_positive_001)
{
    ServiceParserMultipleFt_mock serviceParser;
...
TEST(ServiceParserMultipleFT, checkBoardType_positive_002)
{
    ServiceParserMultipleFt_mock serviceParser;
...
TEST(ServiceParserMultipleFT, checkBoardType_positive_003)
{
    ServiceParserMultipleFt_mock serviceParser;
...
TEST(ServiceParserMultipleFT, checkBoardType_positive_004)
{
    ServiceParserMultipleFt_mock serviceParser;
...
TEST(ServiceParserMultipleFT, checkBoardType_negative_001)
{
    ServiceParserMultipleFt_mock serviceParser;
...
TEST(ServiceParserMultipleFT, checkBoardType_negative_002)
{
    ServiceParserMultipleFt_mock serviceParser;
