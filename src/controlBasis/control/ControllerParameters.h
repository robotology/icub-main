...
namespace CB {
    ...
    public:
        ...
        ControllerParameters(std::string s, std::string r, std::string pf, std::string e, double g=1.0) {
            Sensor = s;
            Effector = e;
            Reference = r;
        ...
        ControllerParameters(std::string s, std::string pf, std::string e, double g=1.0) {
            Sensor = s;
            Effector = e;
            Reference = "";
            PotentialFunction = pf;
