...
private:
    ...
    yarp::os::BufferedPort<yarp::sig::Vector> coordsPort; // for reading coordinates of current detected face
    yarp::os::BufferedPort<yarp::os::Bottle> rewardPort; // for reading the reward given by the motivation dynamics
    yarp::os::BufferedPort<yarp::os::Bottle> soundSensorPort; // sound sensor data from sound server

    // ??
    yarp::os::Port actionPortOut; // for writing actions
    yarp::os::Port expressionRawPort; // for writing actions
