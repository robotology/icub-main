...
*
@ingroup icub_guis
\defgroup icub_selectiveAttentionInterface selectiveAttentionInterface

This module provides a graphical interface for selectiveAttentionEngine module.

\section intro_sec Description
This module sends commands as bottle to the \ref selectiveAttentionEngine "selectiveAttentionEngine"  module. The command respect a communication stardard based
on bottle composed of vocabols


The module does:
- send commands to the selectiveAttentionEngine module
...
- /selectiveAttentionEngine/cmd 


\section portsc_sec Ports Created
Input ports:
- /selectiveAttentionInterface/img:i
Outports
- /selectiveAttentionInterface/cmd
...
selectiveAttentionInterface --name selectiveAttentionInterface
...
private:
    ...
    */
    ...
    /**
    * command port(input) of the module
    */
