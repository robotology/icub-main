...
iCub::contrib::primateVision::Canny::Canny(IppiSize isize_)
{
...
iCub::contrib::primateVision::Canny::~Canny()
{

}

void iCub::contrib::primateVision::Canny::proc(Ipp8u* new_im_,int psb_i_,double TL_, double TU_)
{
  ...
  ippiFilterSobelHorizBorder_8u16s_C1R(new_im,psb_i,
				       ...
				       0, 
				       buf_h);
  ippiFilterSobelVertBorder_8u16s_C1R(new_im,psb_i,
				      pSDy,psb_s,isize, 
				      ippMskSize3x3,
				      ippBorderWrap, 
				      0,
