...
typedef	union {
	...
	int			i[4];	/* Single-precision (32-bit) value */
 	unsigned short			uw[8];	/* Unsigned short (16-bit) value */
...
/*	1x128 MOVe unaligned double quad int
*/
#define	movdqu_r2m(xmmreg, var)	sse_r2m(movdqu, xmmreg, var)
#define	movdqu_m2r(var, xmmreg)	sse_m2r(movdqu, var, xmmreg)

/*	1x128 MOVe aligned double quad int
*/
#define	movdqa_m2r(var, xmmreg)	sse_m2r(movdqa, var, xmmreg)
#define	movdqa_r2r(xmmreg1, xmmreg2)	sse_r2r(movdqa, xmmreg1, xmmreg2)
#define	movdqa_r2m(xmmreg, var)	sse_r2m(movdqa, xmmreg, var)
