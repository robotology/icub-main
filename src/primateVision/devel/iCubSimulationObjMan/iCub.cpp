...
void ICubSim::draw(){
	...
	//RIGHT HAND FINGERS
		...
		DrawBox(0.022,0.069,0.065,false,textured,8);glColor3d(0.0,0.0,1.0);glTranslatef(0.035,-0.05,0.03);DrawSphere(0.03,false,textured,8);glColor3d(1.0,1.0,1.0);glPopMatrix();//Taken from ODE use Y, Z, Xs
...
/*    ballModel->loadModelData(finder.find("data/model/Ball.ms3d").c_str()); 
    bottleModel->loadModelData(finder.find("data/model/Bottle.ms3d").c_str());  
    canModel->loadModelData(finder.find("data/model/Can.ms3d").c_str());  
    duckModel->loadModelData(finder.find("data/model/Duck.ms3d").c_str());  
    mugModel->loadModelData(finder.find("data/model/Mug.ms3d").c_str());  
*/
