...
struct strain::amplifier::PGA308::Impl
{
    ...
    bool load_step1(const DiscreteGain g)
    {
        ...
        static const uint8_t _cfgmap[static_cast<uint8_t>(DiscreteGain::maxnumberof)][6] =
        {
            {0x00, 0x80, 0x66, 0x20, 0x00, 0x80},   // gain = 256
            {0x00, 0x80, 0x56, 0x20, 0x00, 0x80},   // gain = 128
            {0x00, 0x40, 0x56, 0x20, 0x00, 0x80},   // gain = 96
            {0x00, 0x80, 0x46, 0x20, 0x00, 0x80},   // gain = 64          
