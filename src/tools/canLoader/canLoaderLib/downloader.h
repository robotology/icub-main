...
int strain_start_sampling    (int bus, int target_id);
int strain_stop_sampling     (int bus, int target_id);
int strain_calibrate_offset  (int bus, int target_id, unsigned int middle_val);
int strain_get_offset		 (int bus, int target_id, char channel, unsigned int& offset);
int strain_set_offset		 (int bus, int target_id, char channel, unsigned int  offset);
int strain_get_adc			 (int bus, int target_id, char channel, unsigned int& adc, int type);
int strain_save_to_eeprom    (int bus, int target_id);
int strain_get_matrix_rc	 (int bus, int target_id, char r, char c, unsigned int& elem);
int strain_set_matrix_rc	 (int bus, int target_id, char r, char c, unsigned int  elem);
int strain_get_matrix_gain	 (int bus, int target_id, unsigned int& gain);
int strain_set_matrix_gain	 (int bus, int target_id, unsigned int  gain);
int strain_get_calib_bias	 (int bus, int target_id, char channel, signed int& bias);
int strain_set_calib_bias	 (int bus, int target_id);
int strain_set_calib_bias	 (int bus, int target_id, char channel, signed int bias);
int strain_reset_calib_bias	 (int bus, int target_id);
int strain_get_curr_bias	 (int bus, int target_id, char channel, signed int& bias);
int strain_set_curr_bias	 (int bus, int target_id);
int strain_set_curr_bias	 (int bus, int target_id, char channel, signed int bias);
int strain_reset_curr_bias	 (int bus, int target_id);
int strain_set_full_scale	 (int bus, int target_id, unsigned char channel, unsigned int   full_scale);
int strain_get_full_scale	 (int bus, int target_id, unsigned char channel, unsigned int&  full_scale);
int strain_get_serial_number (int bus, int target_id, char* serial_number);
int strain_set_serial_number (int bus, int target_id, const char* serial_number);
int strain_get_eeprom_saved  (int bus, int target_id, bool* status);
