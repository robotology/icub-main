                      ...
                      uint bytesPerPacketDC1394, bool transmissionDC1394)
{
    ...
    ui->m_MenuOpMode->setCurrentText(operationModeDC1394 ? op_mode_labels.at(1):op_mode_labels.at(0));
    ...
    {
        std::cout << "BUS type is " << static_cast<int>(camera.busType) << "; description is " << camera.deviceDescription << std::endl;
...
{
    LOG("on_transmission_onoff_change()\n");
    QVariantList list;
