...
{
    uint videoModeMaskDC1394 = 0;
    DC1394Control->getVideoModeMaskDC1394(videoModeMaskDC1394);
    uint fPSMaskDC1394 = 0;
    DC1394Control->getFPSMaskDC1394(fPSMaskDC1394);
    uint videoMode = 0;
    DC1394Control->getVideoModeDC1394(videoMode);
    uint colorCodingMaskDC1394 = 0;
    DC1394Control->getColorCodingMaskDC1394(videoMode, colorCodingMaskDC1394);
...
//     fgControl->setActive(feature,bON); refresh should not send commands right?
