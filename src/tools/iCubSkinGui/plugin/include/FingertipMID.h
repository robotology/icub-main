...
#ifndef __ALE_FINGERTIPMID_L_H__
#define __ALE_FINGERTIPMID_L_H__

class FingertipMID : public TouchSensor
{
public:
    FingertipMID(double cx,double cy,double th,double gain=1.0,int layoutNum=0,int lrMirror=0)
    {
        dGain=gain;
        ilrMirror=lrMirror;
...
*/               
        ...
        dY[8]= 20.0;  dX[8]= 15.0; 
        dY[9]= 10.0;  dX[9]= 35.0; 
        dY[10]= 0.0; dX[10]= 15.0;
        dY[11]= -20.0; dX[11]= 15.0;        
