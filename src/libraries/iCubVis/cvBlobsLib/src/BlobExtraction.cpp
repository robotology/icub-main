...
#include <iCub/vis/BlobExtraction.h>
...
/*
	Parallelitzaci�del c�cul de la matriu de transicions
...
*/
	if(maskImage == NULL)
	{
		...
		{
			TransitionOffset = iRow*(Cols + 2); //per a que sigui parallitzable
