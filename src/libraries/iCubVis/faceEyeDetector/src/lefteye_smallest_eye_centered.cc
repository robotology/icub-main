/*
 * lefteye_smallest_eye_centered.cc
 *
...
#include <iCub/vis/lefteye_smallest_eye_centered.h>

void lefteye_smallest_eye_centered::assignData(MPEyeFinder *ef, FeatureData &d){
	d.patchsize=25;
	d.patch_width=25;
	d.patch_height=25;
	d.plus_minus_one=0;
