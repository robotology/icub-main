...
{
	string ret = "[Link/frame]: " + info + " [Mode]: " + NE_Mode[mode];
...
{
	string ret = "[Base link]: " + info + " [Mode]: " + NE_Mode[mode];
...
{
	string ret = "[Final link]: " + info + " [Mode]: " + NE_Mode[mode];
...
{
	string ret = "[Sensor link]: " + info + " [Mode]: " + NE_Mode[mode];
