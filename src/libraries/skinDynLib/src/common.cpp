...
SkinPart iCub::skinDynLib::getSkinPartFromString(const std::string skinPartString)
{
   ...
   else if(skinPartString == SkinPart_s[SKIN_LEFT_LEG_UPPER])
        return SKIN_LEFT_LEG_UPPER;
   else if(skinPartString == SkinPart_s[SKIN_LEFT_LEG_LOWER])
        return SKIN_LEFT_LEG_LOWER;
   else if(skinPartString == SkinPart_s[SKIN_LEFT_FOOT])
        return SKIN_LEFT_FOOT;
   else if(skinPartString == SkinPart_s[SKIN_RIGHT_LEG_UPPER])
        return SKIN_RIGHT_LEG_UPPER;
   else if(skinPartString == SkinPart_s[SKIN_RIGHT_LEG_LOWER])
        return SKIN_RIGHT_LEG_LOWER;
   else if(skinPartString == SkinPart_s[SKIN_RIGHT_FOOT])
       return SKIN_RIGHT_FOOT;
   else
