...
const Skin_2_Body SkinPart_2_BodyPart[SKIN_PART_SIZE] = {
    ...
    {SKIN_LEFT_LEG_UPPER,   LEFT_LEG},
    {SKIN_LEFT_LEG_LOWER,   LEFT_LEG},
    {SKIN_LEFT_FOOT,        LEFT_LEG},
    {SKIN_RIGHT_LEG_UPPER,  RIGHT_LEG},
    {SKIN_RIGHT_LEG_LOWER,  RIGHT_LEG},
    {SKIN_RIGHT_FOOT,       RIGHT_LEG},
