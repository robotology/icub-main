...
enum SkinPart { UNKNOWN_SKIN_PART, HAND, FOREARM, UPPER_ARM, ALL_SKIN_PARTS, SKIN_PART_SIZE};
const std::string SkinPart_s[] = {"unknown_skin_part", "hand", "forearm", "upper_arm", "all_skin_parts", "skin_part_size"};
