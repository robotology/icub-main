...
// Generated on: Mon Aug 31 14:52:24 2026
...
bool CouplingICubHandMk2_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="jointNames")
    {
        std::ostringstream oss;
        oss << "( ";
        for (auto x : m_jointNames)
        {
            oss << x << " ";
        }
        oss << " )";
    ...
    if (paramName =="COUPLING::actuatedAxesNames")
    {
        std::ostringstream oss;
        oss << "( ";
        for (auto x : m_COUPLING_actuatedAxesNames)
        {
            oss << x << " ";
        }
        oss << " )";
    ...
    if (paramName =="COUPLING::actuatedAxesPosMin")
    {
        std::ostringstream oss;
        oss << "( ";
        for (auto x : m_COUPLING_actuatedAxesPosMin)
        {
            oss << x << " ";
        }
        oss << " )";
    ...
    if (paramName =="COUPLING::actuatedAxesPosMax")
    {
        std::ostringstream oss;
        oss << "( ";
        for (auto x : m_COUPLING_actuatedAxesPosMax)
        {
            oss << x << " ";
        }
        oss << " )";
...
std::string CouplingICubHandMk2_ParamsParser::getConfiguration() const
{
...
std::string      CouplingICubHandMk2_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + " yarpdev --device couplingICubHandMk2 --jointNames <mandatory_value> --LIMITS::jntPosMin <mandatory_value> --LIMITS::jntPosMax <mandatory_value> --COUPLING::actuatedAxesNames <mandatory_value> --COUPLING::actuatedAxesPosMin <mandatory_value> --COUPLING::actuatedAxesPosMax <mandatory_value>\n";
