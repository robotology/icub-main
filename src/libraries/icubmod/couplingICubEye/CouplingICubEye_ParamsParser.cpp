...
bool CouplingICubEye_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
...
std::string CouplingICubEye_ParamsParser::getConfiguration() const
{
