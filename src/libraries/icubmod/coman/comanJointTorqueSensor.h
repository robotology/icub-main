...
#ifndef __comanJointTorqueSensor_h__
#define __comanJointTorqueSensor_h__
...
namespace yarp {
    namespace dev {
        class comanJointTorqueSensor;
    }
}


class yarp::dev::comanJointTorqueSensor:    public DeviceDriver,
...
#endif // include guard __comanJointTorqueSensor_h__
