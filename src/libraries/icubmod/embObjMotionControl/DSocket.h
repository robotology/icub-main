...
public:
    ...
    ACE_SOCK_Dgram_Bcast* Create(ACE_UINT16 port,std::string& address);
    ACE_SOCK_Dgram_Bcast* Create(ACE_UINT16 port,ACE_UINT32 address);
    ...
    ssize_t ReceiveFrom(void* data,size_t len);
