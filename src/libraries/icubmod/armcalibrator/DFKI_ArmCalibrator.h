 ...
 * \defgroup DFKI_ArmCalibrator DFKI_ArmCalibrator 
 *
 ...
 *
 * This file can be edited at src/modules/armcalibrator/DFKI_ArmCalibrator.h
 */
...
namespace yarp {
    namespace dev
    {
        class DFKI_ArmCalibrator;
    }
}

/**
 * \file DFKI_ArmCalibrator.h 
 ...
 */
class yarp::dev::DFKI_ArmCalibrator : public ICalibrator, public DeviceDriver
{
public:
    /**
     * Default constructor.
