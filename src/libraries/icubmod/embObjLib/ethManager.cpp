...
{    
    ...
    // for tx we must protect the ethresources not being changed. they can be changed by a device such as
...
void EthReceiver::run()
{
    ...
    const ssize_t incoming_msg_capacity = ethResources::maxRXpacketsize;
