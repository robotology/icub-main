...
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__bootprocess(void* p);

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__gotoprocess(void* p);

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__forcerestart(void* p);

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__localise(void* p);

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update_ipnetwork__macaddress(void* p);

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_init_ipnetwork__ipaddress(void* p);
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update_ipnetwork__ipaddress(void* p);

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update_ipnetwork__ipnetmask(void* p);
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__remoteipaddress(void* p);
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__remoteipport(void* p);
...
static const eOnv_fn_peripheral_t s_eo_cfg_nvsEP_base_usr_loc_anydev_action_peripheralinterface_ipnetwork__ipaddress =
{
    EO_INIT(.init)      s_eo_cfg_nvsEP_base_usr_loc_anydev_action_init_ipnetwork__ipaddress,
...
#endif
printf("File eOcfg_nvsEP_base_FakeBoard01.c line %d.\n", __LINE__);
}

//extern void eo_cfg_nvsEP_base_action_initialise__boardinfo(void* p)
//{
//    EOnv *nv = (EOnv*)p;
...
//
//
//extern void eo_cfg_nvsEP_base_action_initialise__applicationinfo(void* p)
//{
//    EOnv *nv = (EOnv*)p;
...
//}
//
//extern void eo_cfg_nvsEP_base_action_initialise_ipnetwork(void* p)
//{
//    EOnv *nv = (EOnv*)p;
//}
...
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__gotoprocess(void* p)
{
    ...
    // set the callback to be called when timer will expire  -> s_eo_cfg_nvsEP_base_usr_loc_anydev_action_gotoprocess_or_forcerestart_callback
...
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__forcerestart(void* p)
{
	...
	printf("File eOcfg_nvsEP_base_FakeBoard01.c line %d.\n", __LINE__);
	printf("\t function s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__forcerestart with parameter %d\n",  *restart );
...
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_init_ipnetwork__ipaddress(void* p)
{
	printf("File eOcfg_nvsEP_base_FakeBoard01.c - init_ipnetwork__ipaddress - line %d.\n", __LINE__);
}
...
// THIS is the callback called when timer expires
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_gotoprocess_or_forcerestart_callback(void *p)
{
#ifdef _orig_
