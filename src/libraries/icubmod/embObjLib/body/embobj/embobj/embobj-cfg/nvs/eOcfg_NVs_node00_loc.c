...
extern volatile eOnode00_loc_t eo_cfg_nvs_node00_loc_vol = { 0 };

// this struct contains the default values of the entities of the whole device

extern const eOnode00_loc_t eo_cfg_nvs_node00_loc_def =
{
    .vportRO                            =
    {
        .cfg =
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_root =
{   // pos =  0
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_vportRO =
{   // pos =  1
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_vportRO__cfg =
{   // pos =  2
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_vportRO__dat =
{   // pos =  3
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_vportWO =
{   // pos =  4
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_vportWO__cfg =
{   // pos =  5
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_vportWO__dat =
{   // pos =  6
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_globalconstants =
{   // pos =  7
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_globcon__macaddr =
{   // pos =  8
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_globcon__ipaddr =
{   // pos =  9
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_globalconfiguration =
{   // pos =  10
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__acquireinput =
{   // pos =  11
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__acquisitionperiod =
{   // pos =  12
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__applyoutput =
{   // pos =  13
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__signalvportro =
{   // pos =  14
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__toipaddr =
{   // pos =  15
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__withperiod =
{   // pos =  16
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_button =
{   // pos =  17
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_button__inputval =
{   // pos =  18
    .id                 = EOK_cfg_nvs_node00_loc_nvID_button,
    .ownership          = eo_nv_ownership_local,
    .data = 
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_button__acquisitiontime =
{   // pos =  19
    .id                 = EOK_cfg_nvs_node00_loc_nvID_button,
    .ownership          = eo_nv_ownership_local,
    .data = 
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_led00 =
{   // pos =  20
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_led00__outputval =
{   // pos =  21
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_led00__lednumber =
{   // pos =  22
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_led01 =
{   // pos =  23
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_led01__outputval =
{   // pos =  24
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ_led01__lednumber =
{   // pos =  25
...
static const EOnetvar s_eo_cfg_nvs_node00_loc_nvOBJ__timeoflife =
{   // pos =  26
...
{
{   // pos = 0
    .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_root,
    .nchildren  = 8,
    .children   = {1, 4, 7, 10, 17, 20, 23, 26}     
 },

/**/{   // pos = 1
        .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_vportRO,
        .nchildren  = 2,
        .children   = {2, 3}
    },
        {   // pos = 2
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_vportRO__cfg,
            .nchildren  = 0,
            .children   = {255}
        },
        {   // pos = 3
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_vportRO__dat,
            .nchildren  = 0,
            .children   = {255}
        },

/**/{   // pos = 4
        .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_vportWO
        .nchildren  = 2,
        .children   = {5, 6}
    },
        {   // pos = 5
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_vportWO__cfg
        },
        {   // pos = 6
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_vportWO__dat
        },

/**/{   // pos = 7
        .nchildren  = 2,
        .children   = {8, 9},
        .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_globalconstants
    },
        {   // pos = 8
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_globcon__macaddr
        },
        {   // pos = 9
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_globcon__ipaddr
        },

/**/{   // pos = 10
        .nchildren  = 6,
        .children   = {11, 12, 13, 14, 15, 16},
        .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_globalconfiguration
    },
        {   // pos = 11
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__acquireinput
        },
        {   // pos = 12
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__acquisitionperiod
        },
        {   // pos = 13
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__applyoutput
        },
        {   // pos = 14
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__signalvportro
        },
        {   // pos = 15
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__toipaddr
        },
        {   // pos = 16
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_globcfg__withperiod
        },
...
/**/{   // pos = 17
        .nchildren  = 2,
        .children   = {18, 19},
        .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_button
    },
        {   // pos = 18
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_button__inputval
        },
        {   // pos = 19
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_button__acquisitiontime
        },
        
/**/{   // pos = 20
        .nchildren  = 2,
        .children   = {21, 22},
        .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_led00
    },
        {   // pos = 21
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_led00__outputval
        },
        {   // pos = 22
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_led00__lednumber
        },        
        
/**/{   // pos = 23
        .nchildren  = 2,
        .children   = {24, 25},
        .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_led01
    },
        {   // pos = 24
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_led01__outputval
        },
        {   // pos = 25
            .nchildren  = 0,
            .children   = {255},
            .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ_led01__lednumber
        },          

/**/{   // pos = 26
        .nchildren  = 0,
        .children   = {255},
        .netvar     = &s_eo_cfg_nvs_node00_loc_nvOBJ__timeoflife
    }
...
extern void node00_loc_init_volatile_data(void)
{
    ...
    s_loc_storage = eo_fakestrg_New(node00_loc_STGid, sizeof(eo_cfg_nvs_node00_loc_def), &eo_cfg_nvs_node00_loc_def);
