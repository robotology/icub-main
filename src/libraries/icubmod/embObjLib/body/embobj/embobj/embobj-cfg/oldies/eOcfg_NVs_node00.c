...
static void s_eo_cfg_nvs_node00_init_volatile_data(void);
static void * s_eo_cfg_nvs_node00_get_loc_storage(void);
static uint16_t s_eo_cfg_nvs_node00_from_ipv4_to_remotedevice_index(eOipv4addr_t ipv4);
...
{
    .fn_get_loc_storage                 = s_eo_cfg_nvs_node00_get_loc_storage,
    .fn_init_volatile_data              = s_eo_cfg_nvs_node00_init_volatile_data,
    .fn_from_ipv4_to_remotedev_index    = s_eo_cfg_nvs_node00_from_ipv4_to_remotedevice_index,
    .localnvs = 
    {
