...
#include "EOtheGPIOCfgMCBSTM32x_hid.h" 
...
{   //  id                                      hal_gpio_port_t                       hal_gpio_pin_t        hal_gpio_val_t 
    {   xbrdwaveLED_ONE,                  hal_gpio_portX,                       hal_gpio_pin8,       hal_gpio_valLOW    },                  
    {   xbrdwaveLED_TWO,                  hal_gpio_portX,                       hal_gpio_pin9,       hal_gpio_valLOW    },
    {   xbrdwaveLED_THREE,                hal_gpio_portX,                       hal_gpio_pin10,       hal_gpio_valLOW    },
    {   xbrdwaveLED_FOUR,                  hal_gpio_portX,                       hal_gpio_pin11,       hal_gpio_valLOW    },
    {   xbrdwaveLED_FIVE,                  hal_gpio_portX,                       hal_gpio_pin12,       hal_gpio_valLOW    },
    {   xbrdwaveLED_SIX,                  hal_gpio_portX,                       hal_gpio_pin13,       hal_gpio_valLOW    },
    {   xbrdwaveLED_SEVEN,                  hal_gpio_portX,                       hal_gpio_pin14,       hal_gpio_valLOW    },
    {   xbrdwaveLED_EIGHT,                  hal_gpio_portX,                       hal_gpio_pin15,       hal_gpio_valLOW    },
...
static const EOtheGPIOCfgMCBSTM32x xxx =
{
