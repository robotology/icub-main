...
static const eOssystem_cfg_t s_syscfg =
{
    .hal_fns                                =
    {
        .hal_base_init                      = s_eos_test_initialise_hal,
    ...
    .fsal_fns                               =
    {
        .fsal_init                          = s_eos_test_initialise_fsal // or NULL
    }, 
    .userdef                                =
    {
        .systickperiod                      = TICK,
...
//    hal_sys_systeminit();
    ...
    hal_gpio_init(hal_gpio_portE, hal_gpio_pin11, hal_gpio_dirOUT, hal_gpio_speed_low);
    ...
    hal_gpio_init(hal_gpio_portE, hal_gpio_pin14, hal_gpio_dirOUT, hal_gpio_speed_low);
    ...
    hal_display_clear(hal_display_col_white);
    hal_display_settext(hal_display_font_24x16, hal_display_col_darkgrey, hal_display_col_yellow);
