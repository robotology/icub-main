...
FILEHANDLE _sys_open (const char *name, int openmode) {
  ...
  return (fsal_retarget_fopen (name, openmode));
}
...
int _sys_close (FILEHANDLE fh) {
  ...
  return (fsal_retarget_fclose(fh));
}
...
//#endif
  ...
  return (fsal_retarget_write (fh, buf, len));
}
...
//#endif
  ...
  return (fsal_retarget_read (fh, buf, len));
}
...
int _sys_seek (FILEHANDLE fh, long pos) {
  ...
  return (fsal_retarget_setfpos (fh, pos));
}
...
int _sys_ensure (FILEHANDLE fh) {
  ...
  return (fsal_retarget_flushbuf (fh));
}
...
long _sys_flen (FILEHANDLE fh) {
  ...
  return (fsal_retarget_get_flen (fh));
}
