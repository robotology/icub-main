...
{ 
    ...
    .extfn               =
    {
        ...
        .hal_flash_init             = NULL, // (fsal_result_t (*)(void)) hal_flash_unlock,  // use unlock ...
        .hal_flash_erase            = NULL, // (fsal_result_t (*)(uint32_t, uint32_t)) hal_flash_erase,
        .hal_flash_read             = NULL,
        .hal_flash_write            = NULL, // (fsal_result_t (*)(uint32_t, uint32_t, void *)) hal_flash_write,
