...
int main(void) 
{
    ...
    hal_sys_systick_sethandler(s_tick, 1000);
...
static void s_test_hal_can(void)
{
    ...
    res = hal_can_init(hal_can_portCAN2, NULL);
    if(hal_res_OK != res)
    {
        return;
    }
    ...
    if(hal_res_OK != res)
    {
     ...
     res = hal_can_enable(hal_can_portCAN2);
    if(hal_res_OK != res)
    {
        return;
    }
...
static void s_test_hal_basic(void)
{
    ...
    hal_sys_systick_sethandler(s_tick, 1000*1000);
