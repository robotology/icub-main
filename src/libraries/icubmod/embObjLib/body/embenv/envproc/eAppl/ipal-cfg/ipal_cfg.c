...
/* Vale: non e' necessario usare queste funzioni per permettere l'accesso thread-safe ai vari task 
ai servizi offerti da ipnet, in quanto i task usano il singleton EOMtheIPnet per usufruire di tali servizi
ed e' compito di tale oggetto assicurarsi che essi vengano usati in modalita' thread-safety. */
        .osal_mutex_new             = NULL, 
...
//        .osal_param_tout_forever    = OSAL_timeINFINITE,
        ...
        .fsal_delete                = NULL, //(int (*)(const char *)) fsal_delete, 
        .fsal_rename                = NULL, //(int (*)(const char *, const char *)) fsal_rename,
        .fsal_find                  = NULL, //(int (*)(const char *, void *)) fsal_find,
...
static void s_ipal_cfg_on_fatal_error(uint32_t errorcode, const char * errormsg)
{
    ...
    static ipal_errorcode_t er = ipal_error_generic;
