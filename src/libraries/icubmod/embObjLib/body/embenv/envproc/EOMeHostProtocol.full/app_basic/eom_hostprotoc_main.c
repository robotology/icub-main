...
static void s_eom_hostprotoc_main_init(void);
...
int main(void)
{
    ...
    eom_sys_Initialise( &eom_hostprotoc_info_syscfg,
                        NULL,                                           // mempool uses calloc
                        &eom_hostprotoc_specialise_errcfg,              // errman
                        &eom_timerman_DefaultCfg,
                        &eom_callbackman_DefaultCfg
                      );  
    
    eom_sys_Start(eom_sys_GetHandle(), s_eom_hostprotoc_main_init);
...
/** @fn         static void s_eom_hostprotoc_main_init(void)
...
static void s_eom_hostprotoc_main_init(void)
{
    //uint8_t *ipaddr = (uint8_t*)&(eom_hostprotoc_info_ipal_cfg->eth_ip);
    ...
    eo_armenv_Initialise(&eom_hostprotoc_info_modinfo, NULL);
    ...
    {
        eomipnet_addr = NULL;
        //ipaddr = (uint8_t*)&(eom_hostprotoc_info_ipal_cfg->eth_ip);
    }
    ...
    eom_ipnet_Initialise(&eom_ipnet_DefaultCfg,
                         eom_hostprotoc_specialise_ipal_cfg, 
                         eomipnet_addr,
                         &eom_hostprotoc_specialise_dtgskt_cfg
                         );
    ...
    eom_hostprotoc_specialise_updserver_start();  


    // ----------------------------------------------------------------------------------------------------------------
    // 5. call specialisation function

    eom_hostprotoc_specialise_otherthings();
