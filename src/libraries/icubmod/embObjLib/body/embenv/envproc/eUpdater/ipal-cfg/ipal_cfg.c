...
//        .osal_param_tout_forever    = OSAL_timeINFINITE,
        ...
        .usr_on_ethframe_received   = appipnet_task_wakeup,
        ...
        .usr_tnet_exec              = apptelnet_onexecupdater,
        .usr_tnet_login_msg         = apptelnet_msg_login,              
        .usr_tnet_welcome_msg       = apptelnet_msg_welcome,
        .usr_tnet_prompt            = apptelnet_prompt
