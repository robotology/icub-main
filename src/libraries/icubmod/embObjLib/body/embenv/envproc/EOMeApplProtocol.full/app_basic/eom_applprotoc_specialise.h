...
// - include guard ----------------------------------------------------------------------------------------------------
#ifndef _EOM_APPLPROTOC_SPECIALISE_H_
#define _EOM_APPLPROTOC_SPECIALISE_H_

// - doxy begin -------------------------------------------------------------------------------------------------------

/** @file       eom_applprotoc_specialise.h
...
extern const ipal_cfg_t*            eom_applprotoc_specialise_ipal_cfg;
