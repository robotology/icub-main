...
void MotionControlParser::parseInfo()
{
    ...
    switch(value)
    {
        ...
        case eoerror_value_MC_ref_setpoint_timeout:
        {
            ...
            switch(timeout_type)
            {
                case 1:  timeout_type_str = "TORQUE";  break;
                case 2:  timeout_type_str = "CURRENT"; break;
                case 3:  timeout_type_str = "PWM";     break;
            ...
            snprintf(str, sizeof(str), " %s (Joint=%s (NIB=%d)). The board isn't receiving %s reference setpoint commands and its control/interaction mode has been automatically switched to position/stiff to prevent damage.",
                     m_dnginfo.baseMessage.c_str(), m_dnginfo.baseInfo.axisName.c_str(), joint_num, timeout_type_str);
            m_dnginfo.baseInfo.finalMessage.append(str);
        } break;
