...
namespace eth {
    ...
    public:
        ...
        bool init2(yarp::os::Searchable &cfgtotal, eOipv4addressing_t& localIPaddressing, eOipv4addr_t remoteIP, uint16_t rxpktsize = maxSizeOfRXpacket);
        ...
        bool get(eOmn_appl_config_t &txcfg);
