 ...
 * \defgroup icubtalkingheadcalibrator icubtalkingheadcalibrator
 *
 ...
 *
 * This file can be edited at src/modules/talkingheadcalibrator/iCubTalkingHeadCalibrator.h
 */

#ifndef __ICUB_TALKINGHEAD_CALIBRATOR__
#define __ICUB_TALKINGHEAD_CALIBRATOR__
...
namespace yarp {
    namespace dev
    {
        class iCubTalkingHeadCalibrator;
    }
}

/**
 * \file iCubTalkingHeadCalibrator.h 
 ...
 */
class yarp::dev::iCubTalkingHeadCalibrator : public ICalibrator, public DeviceDriver
{
public:
    /**
     * Default constructor.
     */
    iCubTalkingHeadCalibrator();
