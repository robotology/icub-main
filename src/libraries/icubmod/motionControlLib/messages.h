...
#define CAN_PROTOCOL_MINOR          6 //this must be smaller or equal than the firmware protocol, otherwise terminates.
#define LAST_BLL_BUILD             87 //this value is used only to print "please update" message
#define LAST_MC4_BUILD             87 //this value is used only to print "please update" message
