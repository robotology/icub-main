...
#define CAN_SET_DEBUG_PARAM_3		14 //TO BE REMOVED
#define CAN_GET_DEBUG_PARAM_3		15 //TO BE REMOVED
#define CAN_SET_DEBUG_PARAM_4		16 //TO BE REMOVED
#define CAN_GET_DEBUG_PARAM_4		17 //TO BE REMOVED
...
#define CAN_SET_DEBUG_PARAM_1		46 //TO BE REMOVED
#define CAN_GET_DEBUG_PARAM_1		47 //TO BE REMOVED
#define CAN_SET_DEBUG_PARAM_2		48 //TO BE REMOVED
#define CAN_GET_DEBUG_PARAM_2		49 //TO BE REMOVED
