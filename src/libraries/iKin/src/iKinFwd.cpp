...
void iCubFinger::allocate(const string &_type)
{
    ...
    if (finger=="thumb")
    {
        if (version=="a")
        {
            H0(0,0)=0.121132;  H0(0,1)=0.043736; H0(0,3)=-0.025391770;
            H0(1,0)=-0.958978; H0(1,1)=0.263104; H0(1,3)=-0.011783901;
            H0(2,0)=0.256297;  H0(2,1)=0.963776; H0(2,3)=-0.0017018;
            H0(3,0)=0.0;       H0(3,1)=0.0;      H0(3,3)=1.0;
        }
        else
        {
            H0(0,0)=0.478469;  H0(0,1)=0.063689; H0(0,3)=-0.024029759;
            H0(1,0)=-0.878095; H0(1,1)=0.039246; H0(1,3)=-0.01193433;
            H0(2,0)=0.004;     H0(2,1)=0.997198; H0(2,3)=-0.00168926;
            H0(3,0)=0.0;       H0(3,1)=0.0;      H0(3,3)=1.0;
        }
    ...
    {        
        H0(0,0)=0.898138; H0(0,1)=0.439714;  H0(0,3)=0.00245549;
        H0(1,0)=-0.43804; H0(1,1)=0.89472;   H0(1,3)=-0.025320433;
        H0(2,0)=0.038324; H0(2,1)=-0.078278; H0(2,3)=-0.010973325;
        H0(3,0)=0.0;      H0(3,1)=0.0;       H0(3,3)=1.0;
    ...
    {
        H0(0,0)=1.0; H0(0,1)=0.0; H0(0,3)=0.0178;
        H0(1,0)=0.0; H0(1,1)=0.0; H0(1,3)=-0.00830233;
        H0(2,0)=0.0; H0(2,1)=1.0; H0(2,3)=-0.0118;
        H0(3,0)=0.0; H0(3,1)=0.0; H0(3,3)=1.0;
...
void iCubLeg::allocate(const string &_type)
{
    ...
    if (getType()=="right")
    {
        ...
        pushLink(new iKinLink(   0.0,     0.0,  M_PI/2.0,  M_PI/2.0,  -17.0*CTRL_DEG2RAD, 119.0*CTRL_DEG2RAD));
        pushLink(new iKinLink(   0.0,  0.2236, -M_PI/2.0, -M_PI/2.0,  -79.0*CTRL_DEG2RAD,  79.0*CTRL_DEG2RAD));
        pushLink(new iKinLink(-0.213,     0.0,      M_PI,  M_PI/2.0, -125.0*CTRL_DEG2RAD,  23.0*CTRL_DEG2RAD));
