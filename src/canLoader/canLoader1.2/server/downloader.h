...
private:
int download_motorola_line(const char* line, int len, int board_pid);
...
int     progress;
int     file_length;
std::list<yarp::String> file_data;
...
int change_board_info  (int target_id, const char* board_info);
