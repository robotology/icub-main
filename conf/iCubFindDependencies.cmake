...
if(icub_firmware_shared_FOUND AND ICUB_USE_icub_firmware_shared)
  ...
  if(icub_firmware_shared_VERSION VERSION_GREATER 4 OR icub_firmware_shared_VERSION VERSION_LESS 1.28.2)
    message(FATAL_ERROR "An old version of icub-firmware-shared has been detected, but at least 1.28.2 is required")
  endif()
endif()
