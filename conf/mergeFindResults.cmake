...
foreach(arg ${ARGN})
  ...
  if(${ARG}_FOUND)
    if(${CMAKE_MINOR_VERSION}.${CMAKE_PATCH_VERSION} LESS 4.8)
      set(b -1)
    else(${CMAKE_MINOR_VERSION}.${CMAKE_PATCH_VERSION} LESS 4.8)
      list(FIND INCLUDES "${${ARG}_INCLUDES}" b)
    endif(${CMAKE_MINOR_VERSION}.${CMAKE_PATCH_VERSION} LESS 4.8)
    if(b LESS 0)
