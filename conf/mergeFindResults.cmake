...
foreach(arg ${ARGN})
  ...
  if(${ARG}_FOUND)
    if(${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION} LESS 2.6 AND ${CMAKE_PATCH_VERSION} LESS 8)
      set(b -1)
    elseif(${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION} LESS 2.6 AND ${CMAKE_PATCH_VERSION} LESS 8)
      list(FIND INCLUDES "${${ARG}_INCLUDES}" b)
    endif(${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION} LESS 2.6 AND ${CMAKE_PATCH_VERSION} LESS 8)
    if(b LESS 0)
