...
Set MiaZona = Sheets(2).Range("A10:M111")
...
DestFile = (Sheets(1).Cells(96, 2).Text & "\" & "icub_left_leg_safe.ini")
...
Close #FileNum
DestFile = (Sheets(1).Cells(96, 2).Text & "\" & "icub_left_leg.ini")
' set the current up to 3Ampere
...
Set MiaZona = Sheets(9).Range("A10:M111")
' si imposta la Inputbox per la richiesta del percorso completo dove salvare
'DestFile = InputBox("Inserisci il nome con cui salvare" _
'& Chr(10) & "(Completo di path):", "Esporta File di testo")
DestFile = (Sheets(1).Cells(96, 2).Text & "\" & "icub_right_leg_safe.ini")
' set the current up to 3Ampere
Sheet9.Cells(5, 2) = 3000
' si ottiene il numero libero disponibile dell'handle (finestra di livello superiore della finestra di 'Excel)
FileNum = FreeFile()
' si imposta un controllo di errori
On Error Resume Next
...
' alla fine dei cicli si chiude il file di destinazione salvandolo
Close #FileNum
DestFile = (Sheets(1).Cells(96, 2).Text & "\" & "icub_right_leg.ini")
' set the current up to 3Ampere
Sheet9.Cells(5, 2) = 7000
' si ottiene il numero libero disponibile dell'handle (finestra di livello superiore della finestra di 'Excel)
FileNum = FreeFile()
' si imposta un controllo di errori
On Error Resume Next
...
Set MiaZona = Sheets(7).Range("A10:M111")
' si imposta la Inputbox per la richiesta del percorso completo dove salvare
'DestFile = InputBox("Inserisci il nome con cui salvare" _
'& Chr(10) & "(Completo di path):", "Esporta File di testo")
...
Set MiaZona = Sheets(3).Range("A10:M111")
' si imposta la Inputbox per la richiesta del percorso completo dove salvare
'DestFile = InputBox("Inserisci il nome con cui salvare" _
'& Chr(10) & "(Completo di path):", "Esporta File di testo")
...
Set MiaZona = Sheets(4).Range("A6:M111")
...
Set MiaZona = Sheets(5).Range("A10:M111")
' si imposta la Inputbox per la richiesta del percorso completo dove salvare
'DestFile = InputBox("Inserisci il nome con cui salvare" _
'& Chr(10) & "(Completo di path):", "Esporta File di testo")
...
Set MiaZona = Sheets(6).Range("A6:M111")
...
Set MiaZona = Sheets(8).Range("A1:R111")
