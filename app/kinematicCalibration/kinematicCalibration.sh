...
case "$1" in
    ...
    start)
                ...
                bash -c "$command &"
                command="yarpdatadumper --name /dump_left_arm --demul 2"
                bash -c "$command &"
                command="yarpdatadumper --name /dump_right_arm --demul 2"
                bash -c "$command &"
                command="yarpdatadumper --name /dump_torso --demul 2"
                bash -c "$command &"
                command="yarpdatadumper --name /dump_inertial --demul 4"
                bash -c "$command &"
                command="yarpdatadumper --name /dump_left_leg --demul 2"
                bash -c "$command &"
                command="yarpdatadumper --name /dump_right_leg --demul 2"
                bash -c "$command &"
