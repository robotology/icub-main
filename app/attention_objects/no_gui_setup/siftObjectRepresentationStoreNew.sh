...
/$ICUB_DIR/src/siftObjectRepresentation/siftObjectRepresentation --name $ROBOT/sift --nameControlboard /controlboard --orderSaccades 1 --storeNewImages 1 --file $ICUB_DIR/app/attention_objects/conf/icubEyes.ini >& sift.output &
