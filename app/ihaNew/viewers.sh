...
case "$1" in
	...
	start)
		...
		# viewer face detector (self)
		#yarpview --name $VIEWER_SELFFACEDETECT_PORT & #--PosX 970 --PosY 800 &

		# viewer salience
		yarpview --name $VIEWER_SALIENCE_PORT & #--PosX 970 --PosY 800 &

		# viewer gaze
		yarpview --name $VIEWER_GAZE_PORT & #--PosX 970 --PosY 800 &
		;;
	start_fdonly)
		# viewer face detector
	...
	connect)
		...
		# selffacedetect
		#yarp wait $VIEWER_SELFFACEDETECT_PORT
		# wait for the facedetector ports
		#yarp wait $SELFFACEDETECT_PORT_OUT
		# connect the facedetector output to its viewer
		#yarp connect $SELFFACEDETECT_PORT_OUT $VIEWER_SELFFACEDETECT_PORT 

		# salience
		yarp wait $VIEWER_SALIENCE_PORT
		# wait for the facedetector ports
		yarp wait $SALIENCE_PORT_OUT
		# connect the salience output to its viewer
		yarp connect $SALIENCE_PORT_OUT $VIEWER_SALIENCE_PORT 

		#gaze
		yarp wait $VIEWER_GAZE_PORT
		# wait for the facedetector ports
		yarp wait $MOBEYE_PORT_OUT
		# connect the salience output to its viewer
		yarp connect $MOBEYE_PORT_OUT $VIEWER_GAZE_PORT 
		;;
	connect_fdonly)
		# wait for ports and then connect
		yarp wait $CAMERA
