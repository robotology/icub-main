...
#CMD="yarpdev --device sound_grabber --subdevice portaudio --rate 44100 --samples 512 --framerate 20 --name $PORTAUDIO_PORT --read $*"
CMD="yarpdev --device sound_grabber --subdevice portaudio --name $PORTAUDIO_PORT --read $*"
# 
################################################################################
