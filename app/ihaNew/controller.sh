...
CMD="$EXEC --name $CONTROLLER_NAME --robot $NAME_ROBOT --file $CONFIG_PATH/$CONFIG_FILE --action_defs $CONFIG_PATH/$ACTIONDEFS_FILE --sequence_dir $CONFIG_PATH/$SEQUENCE_DIR --speed_multiplier 3 $*"
