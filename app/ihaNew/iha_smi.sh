...
CMD="$EXEC --name $SMI_INTERFACE_NAME --file $CONFIG_PATH/$CONFIG_FILE  --connect_to_image $CAMERA --connect_to_face_coords $FACEDETECT_PORT_DETECT --connect_to_gaze_coords $MOBEYE_PORT_DETECT --connect_to_reward $DYNAMICS_PORT_REWARD_OUT --connect_to_soundsensor $SOUNDSERVER_PORT_OUT --connect_to_encoders $CONTROLLER_ENCODERS_OUT --connect_to_beat $AUDIOANALYSER_PORT_OUT --gaze_input TRUE --beat_input TRUE $*"
# 
################################################################################
