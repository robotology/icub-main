...
CMD="$EXEC --name $DYNAMICS_NAME --file $CONFIG_PATH/$CONFIG_FILE --connect_to_data $SMI_INTERFACE_SENSORS_OUT --connect_to_mem $STM_SCORE_OUT --connect_to_expression $EXPRESSION_RAW_PORT --reward_contrib_gaze 0.0 --reward_contrib_face 0.0 --reward_contrib_sound 0.0 $*"
