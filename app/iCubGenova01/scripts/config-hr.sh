...
DRAGONFLY_WIDTH=640
DRAGONFLY_HEIGHT=480

DRAGONFLY_VIDEO_TYPE=0

DRAGONFLY_DEVICE_RIGHT=0
DRAGONFLY_DEVICE_LEFT=1

DRAGONFLY_BRIGTH_LEFT=0
DRAGONFLY_EXP_LEFT=0.4
DRAGONFLY_RED_LEFT=0.54
DRAGONFLY_BLUE_LEFT=0.51
DRAGONFLY_SHUTTER_LEFT=0.824
DRAGONFLY_GAIN_LEFT=0.365
...
DRAGONFLY_SHUTTER_RIGHT=0.361
DRAGONFLY_GAIN_RIGHT=0.6
DRAGONFLY_IRIS_RIGHT=0.98

DRAGONFLY_SATURATION=0.183
DRAGONFLY_GAMMA=0.383
DRAGONFLY_HUE=0.48
...
DRAGONFLY_CONFIG_LEFT="--device grabber --subdevice dragonfly --width $DRAGONFLY_WIDTH --height $DRAGONFLY_HEIGHT --video_type $DRAGONFLY_VIDEO_TYPE --white_balance $DRAGONFLY_RED_LEFT $DRAGONFLY_BLUE_LEFT --gain $DRAGONFLY_GAIN_LEFT --shutter $DRAGONFLY_SHUTTER_LEFT --iris $DRAGONFLY_IRIS_LEFT --brightness $DRAGONFLY_BRIGHT_LEFT --exposure $DRAGONFLY_EXP_LEFT --name $NAME_SOURCE_IMAGE_LEFT --DR2 --stamp --d $DRAGONFLY_DEVICE_LEFT --sharpness $DRAGONFLY_SHARPNESS --hue $DRAGONFLY_HUE --gamma $DRAGONFLY_GAMMA --saturation $DRAGONFLY_SATURATION --framerate $DRAGONFLY_FRAMERATE"
